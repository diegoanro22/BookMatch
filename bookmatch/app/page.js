        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div class="text-center">
            <div className="w-32 h-32 mx-auto mb-6">
              <Image src="/bookmatch0.png" alt="BookMatch Image" width={100} height={100} />
            </div>
            <p class="mt-6 text-lg leading-8 text-gray-600">Book Match es tu destino literario personalizado, donde las recomendaciones de libros cobran vida. Descubre lecturas que se alinean perfectamente con tus gustos y sumérgete en una experiencia de descubrimiento literario única y enriquecedora.</p>
